...
const PRODUCTS = [
  {
    ...
    updated: '2h ago',
    users: 1482,
    desc: 'AI-powered external cheat for current Fortnite. YOLOv8 model reads your screen and moves your mouse — adaptive aim that mirrors your natural movement style so it looks entirely human. Never touches game memory. EAC and BattlEye have zero footprint to scan.',
    features: [
      'AI Aimbot — YOLOv8 screen detection, mouse-only control',
      'Adaptive smoothing — mimics your natural aim style',
      'Movement prediction — leads targets based on detected velocity',
      'Triggerbot — auto-clicks when enemy enters crosshair',
      'Silent Aim — micro-correction without visible cursor snap',
      'Player ESP overlay — box, skeleton, health bar, distance',
      'Loot ESP — highlights chests & floor drops on-screen',
      'Material Counter — reads HUD for wood/brick/metal totals',
      'Mouse-based recoil compensation — no game input needed',
      'Adjustable FOV circle, confidence threshold & bone target',
      'Stream-proof overlay — invisible to OBS & recordings',
      'Config profiles — save & switch legit / full-send setups',
    ],
    tiers: [
  ...
  },
  {
    ...
    updated: '1d ago',
    users: 634,
    desc: 'Same AI engine, fully retrained on OG character models and classic skin datasets. Mouse recoil comp tuned for OG weapon bloom patterns. 100% external — reads your screen, moves your mouse, touches nothing inside the game.',
    features: [
      'AI Aimbot — model retrained on OG skin & character data',
      'OG bloom compensation — mouse offsets tuned per legacy weapon',
      'Movement prediction calibrated for OG player speeds',
      'Triggerbot — fires on screen-detected enemy lock',
      'Player ESP overlay — box, skeleton, health, shield, distance',
      'Loot ESP — season-accurate item & chest highlighting',
      'Vehicle detection — highlights ATKs, golf carts & planes',
      'HUD reader — tracks health & shield from screen',
      'Mouse-based recoil compensation — fully external',
      'Adjustable FOV, smoothing & confidence threshold',
      'Stream-proof overlay — invisible to capture software',
      'Low GPU inference mode for older hardware',
    ],
    tiers: [
  ...
  },
  {
    ...
    updated: '5h ago',
    users: 2109,
    desc: 'AI-driven external cheat for CS2. Neural net reads your screen and controls only your mouse — organic movement curves based on your sensor data, indistinguishable from real aim. No VAC-triggering memory reads, no injection. Legit and rage profiles included.',
    features: [
      'Neural Aimbot — screen-only, rage & legit mouse profiles',
      'Per-weapon aim tuning — AK, M4, AWP, pistol presets',
      'Triggerbot — auto-click on detected enemy, randomized delay',
      'Mouse Recoil Control — spray compensation via mouse movement',
      'Movement prediction — leads peeking enemies on detection',
      'Player ESP overlay — box, skeleton, health, weapon label',
      'Crosshair placement coach — overlay hints for pre-aim spots',
      'Scope zoom detection — adjusts sensitivity automatically',
      'Adjustable FOV circle, hitchance filter & bone selection',
      'Silent Aim — frame-perfect micro-correction, no visible snap',
      'Stream-proof overlay — never appears in OBS or Twitch',
      'Config profiles — save, share & hotswap setups mid-game',
    ],
    tiers: [
      { label: 'Day',   price: '$10', sub: '24 hours' },
