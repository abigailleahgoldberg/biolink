...
const PRODUCTS = [
  {
    ...
    updated: '2h ago',
    users: 1482,
    desc: 'AI-powered external cheat for current Fortnite. YOLOv8 model detects enemies from your screen capture — adaptive aim that learns your mouse style so it looks completely human. No DLL, no memory reads, EAC and BattlEye see nothing.',
    features: [
      'Adaptive AI Aimbot — learns your natural mouse curve',
      'Aim prediction — leads moving targets automatically',
      'Silent Aim — bullets snap without visible cursor movement',
      'Triggerbot — auto-fires on enemy detection',
      'Player ESP — skeleton, box, health bar, distance, name',
      'Loot ESP — rarity-sorted chests, ammo, floor drops',
      'Build ESP + Material Counter overlay',
      'Grenade trajectory + blast radius visualizer',
      'Minimap radar — real-time enemy positions',
      'No Recoil + No Spread — full weapon control',
      'Stream-proof overlay — hidden from OBS & recordings',
      'Config profiles — save & switch legit / rage setups',
    ],
    tiers: [
  ...
  },
  {
    ...
    updated: '1d ago',
    users: 634,
    desc: 'Same AI engine, fully retrained on OG character models, legacy skin datasets, and classic season loot tables. Bloom compensation tuned for OG weapon spread patterns. External process, zero injection risk.',
    features: [
      'AI Aimbot — retrained on OG skin dataset',
      'Bloom & bullet spread compensation for legacy weapons',
      'Aim prediction tuned for OG movement speeds',
      'Player ESP — skeleton, health, shield, distance',
      'Season-accurate Loot ESP — OG chest & floor loot only',
      'Vehicle ESP — golf carts, ATKs, planes',
      'Grenade trajectory visualizer',
      'Minimap radar — full enemy positions',
      'No Recoil + No Spread config',
      'Stream-proof overlay — invisible to capture software',
      'Low GPU footprint inference mode',
      'Config profiles — save & switch setups',
    ],
    tiers: [
  ...
  },
  {
    ...
    updated: '5h ago',
    users: 2109,
    desc: 'AI-driven external cheat for CS2. Neural network identifies enemies from screen capture — organic movement curves based on your sensor data, indistinguishable from real aim. No VAC-triggering memory reads, no injection. Rage and legit configs included.',
    features: [
      'Neural Aimbot — rage & legit profiles, per-weapon tuning',
      'Multipoint hitbox scan + hitchance control',
      'Triggerbot — magnetic aim, randomized delays, burst mode',
      'Recoil Control System (RCS) — per-weapon spray patterns',
      'Backtrack — snap to recent enemy positions',
      'ESP — boxes, skeletons, chams, health, weapon, flags',
      'Sound ESP — visualizes enemy footsteps & reload sounds',
      'Grenade prediction + grenade helper overlay',
      'Bomb timer + bomb site info panel',
      'Full Skin Changer — knives, gloves, stickers, StatTrak',
      'Bunny Hop + Edge Jump + Auto Stop movement tools',
      'Stream-proof visuals — clean on OBS & Twitch',
    ],
    tiers: [
      { label: 'Day',   price: '$10', sub: '24 hours' },
